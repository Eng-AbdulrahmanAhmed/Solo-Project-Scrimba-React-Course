...
export default function StartScreen({ onStart }: StartScreenProps) {
    return (
        <section className="start-screen">
            ...
            <p className="start-screen-description">Test your knowledge with our fun and challenging quiz game! Click the button below to start playing and see how many questions you can answer correctly.</p>
            <button className="start-screen-button" onClick={onStart}>Start Quiz</button>
        </section>
    )
}